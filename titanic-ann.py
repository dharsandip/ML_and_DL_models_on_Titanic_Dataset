...
#-----------Applying Deep Artificial Neural Networks (ANN)----------------------------------------------------------
...
classifier.add(Dense(output_dim = 25, init = 'uniform', activation = 'relu', input_dim = 9))
...
classifier.fit(X_train, y_train, batch_size = 20, nb_epoch = 480)
...
#..........k-fold cross validation of the training dataset--------------------------------------------
...
classifier = KerasClassifier(build_fn = build_classifier, batch_size = 20, epochs = 480)
